...
export declare namespace Flamework {
    ...
    export const metadata: Map<Constructor<unknown>, Metadata>;
    export const targetToId: Map<Constructor<unknown>, string>;
    export const idToTarget: Map<string, Constructor<unknown>>;
    /** @hidden */
    export function registerMetadata(target: defined, data: Metadata): void;
    /** @hidden */
     ...
     */
    export function ignite(patchedConfig?: Partial<FlameworkConfig>): [unknown, Metadata, LoadableConfigs][];
    /**
     ...
     * Creates a type guard from any arbitrary type.
     */
    export function createEvent<S, C>(serverMiddleware?: Networking.EventMiddleware<S>, clientMiddleware?: Networking.EventMiddleware<C>): Networking.EventType<S, C>;
    /**
