...
exports.DependencyMacro = {
    ...
    transform: function (state, node) {
        var _a, _b, _c;
        var importId = state.addFileImport(state.getSourceFile(node), "@rbxts/flamework", "Flamework");
        ...
        if (firstArg && !firstType) {
            ...
            if (!declaration)
                diagnostics_1.Diagnostics.error(firstArg, "Could not find declaration");
            return factory_1.f.as(factory_1.f.call(factory_1.f.field(importId, "resolveDependency"), [state.getUid(declaration)]), factory_1.f.referenceType(firstArg));
        }
            ...
            var declaration = (_c = symbol.declarations) === null || _c === void 0 ? void 0 : _c[0];
            if (!declaration)
                diagnostics_1.Diagnostics.error(firstType, "Could not find declaration");
            return factory_1.f.as(factory_1.f.call(factory_1.f.field(importId, "resolveDependency"), [factory_1.f.string(state.getUid(declaration))]), firstType);
        }
        else {
