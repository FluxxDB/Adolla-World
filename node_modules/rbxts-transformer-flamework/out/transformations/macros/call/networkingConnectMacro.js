...
exports.NetworkingConnectMacro = {
    getSymbol: function (state) {
        ...
        var networking = symbols.getFile("@rbxts/flamework/networking").getNamespace("Networking");
    ...
    transform: function (state, node, macro) {
        ...
        return factory_1.f.update.call(node, node.expression, [event, cb, generatedGuards]);
    },
};
