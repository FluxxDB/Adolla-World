...
var TransformState = /** @class */ (function () {
    function TransformState(program, context, config) {
        ...
        this.config = config;
        this.currentDirectory = this.program.getCurrentDirectory();
    ...
    TransformState.prototype.setupBuildInfo = function () {
        ...
        var nodeModules = path_1.default.join(this.currentDirectory, "node_modules");
        var candidates = cache_1.Cache.buildInfoCandidates || (cache_1.Cache.buildInfoCandidates = buildInfo_1.BuildInfo.findCandidates(nodeModules));
        try {
            for (var candidates_1 = __values(candidates), candidates_1_1 = candidates_1.next(); !candidates_1_1.done; candidates_1_1 = candidates_1.next()) {
                ...
                if (buildInfo) {
                    logger_1.Logger.info("Loaded buildInfo at " + relativeCandidate + ", next id: " + buildInfo.getLatestId());
    ...
    TransformState.prototype.setupRojo = function () {
        ...
        var rojoConfig = rojoResolver_1.RojoResolver.findRojoConfigFilePath(this.program.getCurrentDirectory());
        if (rojoConfig) {
        ...
        try {
            for (var CALL_MACROS_1 = __values(callMacros_1.CALL_MACROS), CALL_MACROS_1_1 = CALL_MACROS_1.next(); !CALL_MACROS_1_1.done; CALL_MACROS_1_1 = CALL_MACROS_1.next()) {
                ...
                if (Array.isArray(symbols)) {
                    try {
                        for (var symbols_1 = (e_3 = void 0, __values(symbols)), symbols_1_1 = symbols_1.next(); !symbols_1_1.done; symbols_1_1 = symbols_1.next()) {
    ...
    TransformState.prototype.addFileImport = function (file, importPath, name) {
        ...
        if (importPath === "@rbxts/flamework") {
            ...
            var flameworkPath = path_1.default.join(flameworkDir, "flamework");
            if (isPathDescendantOf_1.isPathDescendantOf(file.fileName, flameworkDir)) {
                importPath = "./" + path_1.default.relative(path_1.default.dirname(file.fileName), flameworkPath) || ".";
            }
        }
            ...
            try {
                start: for (var _d = __values(file.statements), _e = _d.next(); !_e.done; _e = _d.next()) {
                    ...
                    if (statement.moduleSpecifier.text !== importPath)
                        continue;
                    try {
                        for (var _f = (e_5 = void 0, __values(statement.importClause.namedBindings.elements)), _g = _f.next(); !_g.done; _g = _f.next()) {
    ...
    TransformState.prototype.getSourceFile = function (node) {
        return typescript_1.default.getSourceFileOfNode(node);
    };
    ...
    TransformState.prototype.getInternalId = function (node, extra) {
        ...
        var relativePath = path_1.default.relative(directory, filePath.replace(/(\.d)?.ts$/, ""));
    ...
    TransformState.prototype.getUid = function (node) {
        ...
        var newId = this.hash(this.buildInfo.getLatestId());
